...
<div class="grid grid-cols-2 sm:grid-rows-3 lg:grid-rows-7 gap-0">
    {{-- ROW 1 --}}
    ...
    {{-- ROW 2 --}}
    <div id="contact-info" class="col-span-1 h-140 text-black hidden lg:block">
    ...
    {{-- ROW 4 --}}
    <div class="col-span-1 bg-[url(/img/003-book-a-taxi-to-the-airport-almuñecar.png)] bg-cover h-140 text-white font-bold hidden lg:block">
    </div>
    <div class="col-span-1 h-140 text-black hidden lg:block">
    ...
    {{-- ROW 7 --}}
    <div class="sm:col-span-2 lg:col-span-1 bg-[url(/img/istockphoto-1191221365.jpg)] bg-cover bg-left-bottom h-140 text-white hidden lg:block">
    </div>
    <div class="col-span-1 mt-8 text-black hidden lg:block">
